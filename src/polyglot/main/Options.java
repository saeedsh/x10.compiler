...
public class Options {
    ...
    /** Count number of fors */
    public boolean count_number_of_fors = false;
    
    /** Fix race condition */
    public boolean fix_race = false;
    ...
    protected int parseCommand(String args[], int index, Set<String> source) 
        ...
        else if (args[i].startsWith("-COUNT_FORS")) {
        	count_number_of_fors = true;
            i++;
        }
        else if (args[i].startsWith("-FIX_RACE")) {
        	fix_race = true;
            i++;
        }
